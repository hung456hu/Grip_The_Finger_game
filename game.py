...
class GameStartGUI:
    def __init__(self):
        self.window_name = "Hand Tracking Game - Start"
    ...
    def show_start_screen(self):
        ...
        while True:
            ...
            cv2.putText(start_screen, 'Press Q to Quit', (50, 350), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
    ...
    def select_timer(self):
        ...
        while True:
            ...
            cv2.putText(timer_screen, 'Press B to go back to menu', (50, 350), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), 2)
            cv2.putText(timer_screen, 'Press Q to quit', (50, 400), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), 2)
                    ...
                    for hand_landmarks in results.multi_hand_landmarks:
                        ...
                        if folded_fingers_text in self.sequence:
                            if folded_fingers_text == self.sequence[self.index]:
                                ...
                                cv2.putText(image, 'Wrong! Try Again.', (50, 300), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 255), 2)

                        cv2.putText(image, f'Score: {self.loop}', (50, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255, 255, 255), 2)
                        cv2.putText(image, f'Sequence: {", ".join(self.sequence[:self.index+1])}', (50, 200), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255, 255, 255), 2)
                        cv2.putText(image, f'Folded Fingers: {folded_fingers_text}', (50, 250), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 255, 0), 2)
